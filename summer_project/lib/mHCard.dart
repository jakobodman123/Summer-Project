                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                ItemBox(
                                    itemID: widget.player?.item0.toString()),
                                ItemBox(
                                    itemID: widget.player?.item1.toString()),
                                ItemBox(
                                    itemID: widget.player?.item2.toString()),
                                Container(
                                  height: 35 * 0.7,
                                  width: 35 * 0.7,
                                  decoration: BoxDecoration(
                            ...
                            Row(
                              children: [
                                ItemBox(
                                    itemID: widget.player?.item3.toString()),
                                ItemBox(
                                    itemID: widget.player?.item4.toString()),
                                ItemBox(
                                    itemID: widget.player?.item5.toString()),
                              ],
                            ),
